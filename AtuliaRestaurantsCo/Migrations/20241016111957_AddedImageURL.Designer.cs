...
namespace AtuliaRestaurantsCo.Migrations
{
    ...
    [Migration("20241016111957_AddedImageURL")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.Ingredient", b =>
                {
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.ProductIngredient", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.Order", b =>
                {
                    b.HasOne("AtuliaRestaurantsCo.Models.ApplicationUser", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.OrderItem", b =>
                {
                    b.HasOne("AtuliaRestaurantsCo.Models.Order", "Order")
                        .WithMany("OrderItem")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AtuliaRestaurantsCo.Models.Product", "Product")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.Product", b =>
                {
                    b.HasOne("AtuliaRestaurantsCo.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("AtuliaRestaurantsCo.Models.ProductIngredient", b =>
                {
                    b.HasOne("AtuliaRestaurantsCo.Models.Ingredient", "Ingredient")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AtuliaRestaurantsCo.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
